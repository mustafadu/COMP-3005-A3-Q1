...
- open cmd
- by using cmd, go to the directory
- run python3 program.py
- the program will ask you 5 questions
- to print all the students in the database press 1
- to add a student press 2, and provide correct information
